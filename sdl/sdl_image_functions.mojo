...
struct SdlImageFunctions:
    ...
    fn __init__(out self, sdl3_functions: Sdl3Functions, library_path: Path) raises:
        ...
        self._version = self.dynamic_library_handle.get_function[fn() -> Int32]("IMG_Version")
        self._load = self.dynamic_library_handle.get_function[fn(Ptr[c_char, ImmutExternalOrigin]) -> Ptr[Surface, MutExternalOrigin]]("IMG_Load")
        self._load_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin], Bool) -> Ptr[Surface, MutExternalOrigin]]("IMG_Load_IO")
        self._load_typed_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin], Bool, Ptr[c_char, ImmutExternalOrigin]) -> Ptr[Surface, MutExternalOrigin]]("IMG_LoadTyped_IO")
        self._load_texture = self.dynamic_library_handle.get_function[fn(Ptr[Renderer, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin]) -> Ptr[Texture, MutExternalOrigin]]("IMG_LoadTexture")
        self._load_texture_io = self.dynamic_library_handle.get_function[fn(Ptr[Renderer, MutExternalOrigin], Ptr[IOStream, MutExternalOrigin], Bool) -> Ptr[Texture, MutExternalOrigin]]("IMG_LoadTexture_IO")
        self._load_texture_typed_io = self.dynamic_library_handle.get_function[fn(Ptr[Renderer, MutExternalOrigin], Ptr[IOStream, MutExternalOrigin], Bool, Ptr[c_char, ImmutExternalOrigin]) -> Ptr[Texture, MutExternalOrigin]]("IMG_LoadTextureTyped_IO")
        self._load_gpu_texture = self.dynamic_library_handle.get_function[fn(Ptr[GPUDevice, MutExternalOrigin], Ptr[GPUCopyPass, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin], Ptr[Int32, MutExternalOrigin], Ptr[Int32, MutExternalOrigin]) -> Ptr[GPUTexture, MutExternalOrigin]]("IMG_LoadGPUTexture")
        self._load_gpu_texture_io = self.dynamic_library_handle.get_function[fn(Ptr[GPUDevice, MutExternalOrigin], Ptr[GPUCopyPass, MutExternalOrigin], Ptr[IOStream, MutExternalOrigin], Bool, Ptr[Int32, MutExternalOrigin], Ptr[Int32, MutExternalOrigin]) -> Ptr[GPUTexture, MutExternalOrigin]]("IMG_LoadGPUTexture_IO")
        self._load_gpu_texture_typed_io = self.dynamic_library_handle.get_function[fn(Ptr[GPUDevice, MutExternalOrigin], Ptr[GPUCopyPass, MutExternalOrigin], Ptr[IOStream, MutExternalOrigin], Bool, Ptr[c_char, ImmutExternalOrigin], Ptr[Int32, MutExternalOrigin], Ptr[Int32, MutExternalOrigin]) -> Ptr[GPUTexture, MutExternalOrigin]]("IMG_LoadGPUTextureTyped_IO")
        self._get_clipboard_image = self.dynamic_library_handle.get_function[fn() -> Ptr[Surface, MutExternalOrigin]]("IMG_GetClipboardImage")
        self._is_ani = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Bool]("IMG_isANI")
        self._is_avif = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Bool]("IMG_isAVIF")
        self._is_cur = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Bool]("IMG_isCUR")
        self._is_bmp = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Bool]("IMG_isBMP")
        self._is_gif = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Bool]("IMG_isGIF")
        self._is_ico = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Bool]("IMG_isICO")
        self._is_jpg = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Bool]("IMG_isJPG")
        self._is_jxl = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Bool]("IMG_isJXL")
        self._is_lbm = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Bool]("IMG_isLBM")
        self._is_pcx = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Bool]("IMG_isPCX")
        self._is_png = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Bool]("IMG_isPNG")
        self._is_pnm = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Bool]("IMG_isPNM")
        self._is_qoi = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Bool]("IMG_isQOI")
        self._is_svg = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Bool]("IMG_isSVG")
        self._is_tif = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Bool]("IMG_isTIF")
        self._is_webp = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Bool]("IMG_isWEBP")
        self._is_xcf = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Bool]("IMG_isXCF")
        self._is_xpm = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Bool]("IMG_isXPM")
        self._is_xv = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Bool]("IMG_isXV")
        self._load_avif_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Ptr[Surface, MutExternalOrigin]]("IMG_LoadAVIF_IO")
        self._load_bmp_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Ptr[Surface, MutExternalOrigin]]("IMG_LoadBMP_IO")
        self._load_cur_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Ptr[Surface, MutExternalOrigin]]("IMG_LoadCUR_IO")
        self._load_gif_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Ptr[Surface, MutExternalOrigin]]("IMG_LoadGIF_IO")
        self._load_ico_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Ptr[Surface, MutExternalOrigin]]("IMG_LoadICO_IO")
        self._load_jpg_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Ptr[Surface, MutExternalOrigin]]("IMG_LoadJPG_IO")
        self._load_jxl_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Ptr[Surface, MutExternalOrigin]]("IMG_LoadJXL_IO")
        self._load_lbm_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Ptr[Surface, MutExternalOrigin]]("IMG_LoadLBM_IO")
        self._load_pcx_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Ptr[Surface, MutExternalOrigin]]("IMG_LoadPCX_IO")
        self._load_png_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Ptr[Surface, MutExternalOrigin]]("IMG_LoadPNG_IO")
        self._load_pnm_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Ptr[Surface, MutExternalOrigin]]("IMG_LoadPNM_IO")
        self._load_svg_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Ptr[Surface, MutExternalOrigin]]("IMG_LoadSVG_IO")
        self._load_sized_svg_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin], Int32, Int32) -> Ptr[Surface, MutExternalOrigin]]("IMG_LoadSizedSVG_IO")
        self._load_qoi_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Ptr[Surface, MutExternalOrigin]]("IMG_LoadQOI_IO")
        self._load_tga_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Ptr[Surface, MutExternalOrigin]]("IMG_LoadTGA_IO")
        self._load_tif_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Ptr[Surface, MutExternalOrigin]]("IMG_LoadTIF_IO")
        self._load_webp_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Ptr[Surface, MutExternalOrigin]]("IMG_LoadWEBP_IO")
        self._load_xcf_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Ptr[Surface, MutExternalOrigin]]("IMG_LoadXCF_IO")
        self._load_xpm_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Ptr[Surface, MutExternalOrigin]]("IMG_LoadXPM_IO")
        self._load_xv_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Ptr[Surface, MutExternalOrigin]]("IMG_LoadXV_IO")
        self._read_xpm_from_array = self.dynamic_library_handle.get_function[fn(Ptr[Ptr[c_char, MutExternalOrigin], MutExternalOrigin]) -> Ptr[Surface, MutExternalOrigin]]("IMG_ReadXPMFromArray")
        self._read_xpm_from_array_to_rg_b888 = self.dynamic_library_handle.get_function[fn(Ptr[Ptr[c_char, MutExternalOrigin], MutExternalOrigin]) -> Ptr[Surface, MutExternalOrigin]]("IMG_ReadXPMFromArrayToRGB888")
        self._save = self.dynamic_library_handle.get_function[fn(Ptr[Surface, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin]) -> Bool]("IMG_Save")
        self._save_typed_io = self.dynamic_library_handle.get_function[fn(Ptr[Surface, MutExternalOrigin], Ptr[IOStream, MutExternalOrigin], Bool, Ptr[c_char, ImmutExternalOrigin]) -> Bool]("IMG_SaveTyped_IO")
        self._save_avif = self.dynamic_library_handle.get_function[fn(Ptr[Surface, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin], Int32) -> Bool]("IMG_SaveAVIF")
        self._save_avif_io = self.dynamic_library_handle.get_function[fn(Ptr[Surface, MutExternalOrigin], Ptr[IOStream, MutExternalOrigin], Bool, Int32) -> Bool]("IMG_SaveAVIF_IO")
        self._save_bmp = self.dynamic_library_handle.get_function[fn(Ptr[Surface, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin]) -> Bool]("IMG_SaveBMP")
        self._save_bmp_io = self.dynamic_library_handle.get_function[fn(Ptr[Surface, MutExternalOrigin], Ptr[IOStream, MutExternalOrigin], Bool) -> Bool]("IMG_SaveBMP_IO")
        self._save_cur = self.dynamic_library_handle.get_function[fn(Ptr[Surface, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin]) -> Bool]("IMG_SaveCUR")
        self._save_cur_io = self.dynamic_library_handle.get_function[fn(Ptr[Surface, MutExternalOrigin], Ptr[IOStream, MutExternalOrigin], Bool) -> Bool]("IMG_SaveCUR_IO")
        self._save_gif = self.dynamic_library_handle.get_function[fn(Ptr[Surface, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin]) -> Bool]("IMG_SaveGIF")
        self._save_gif_io = self.dynamic_library_handle.get_function[fn(Ptr[Surface, MutExternalOrigin], Ptr[IOStream, MutExternalOrigin], Bool) -> Bool]("IMG_SaveGIF_IO")
        self._save_ico = self.dynamic_library_handle.get_function[fn(Ptr[Surface, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin]) -> Bool]("IMG_SaveICO")
        self._save_ico_io = self.dynamic_library_handle.get_function[fn(Ptr[Surface, MutExternalOrigin], Ptr[IOStream, MutExternalOrigin], Bool) -> Bool]("IMG_SaveICO_IO")
        self._save_jpg = self.dynamic_library_handle.get_function[fn(Ptr[Surface, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin], Int32) -> Bool]("IMG_SaveJPG")
        self._save_jpg_io = self.dynamic_library_handle.get_function[fn(Ptr[Surface, MutExternalOrigin], Ptr[IOStream, MutExternalOrigin], Bool, Int32) -> Bool]("IMG_SaveJPG_IO")
        self._save_png = self.dynamic_library_handle.get_function[fn(Ptr[Surface, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin]) -> Bool]("IMG_SavePNG")
        self._save_png_io = self.dynamic_library_handle.get_function[fn(Ptr[Surface, MutExternalOrigin], Ptr[IOStream, MutExternalOrigin], Bool) -> Bool]("IMG_SavePNG_IO")
        self._save_tga = self.dynamic_library_handle.get_function[fn(Ptr[Surface, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin]) -> Bool]("IMG_SaveTGA")
        self._save_tga_io = self.dynamic_library_handle.get_function[fn(Ptr[Surface, MutExternalOrigin], Ptr[IOStream, MutExternalOrigin], Bool) -> Bool]("IMG_SaveTGA_IO")
        self._save_webp = self.dynamic_library_handle.get_function[fn(Ptr[Surface, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin], Float32) -> Bool]("IMG_SaveWEBP")
        self._save_webp_io = self.dynamic_library_handle.get_function[fn(Ptr[Surface, MutExternalOrigin], Ptr[IOStream, MutExternalOrigin], Bool, Float32) -> Bool]("IMG_SaveWEBP_IO")
        self._load_animation = self.dynamic_library_handle.get_function[fn(Ptr[c_char, ImmutExternalOrigin]) -> Ptr[IMG_Animation, MutExternalOrigin]]("IMG_LoadAnimation")
        self._load_animation_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin], Bool) -> Ptr[IMG_Animation, MutExternalOrigin]]("IMG_LoadAnimation_IO")
        self._load_animation_typed_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin], Bool, Ptr[c_char, ImmutExternalOrigin]) -> Ptr[IMG_Animation, MutExternalOrigin]]("IMG_LoadAnimationTyped_IO")
        self._load_ani_animation_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Ptr[IMG_Animation, MutExternalOrigin]]("IMG_LoadANIAnimation_IO")
        self._load_apng_animation_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Ptr[IMG_Animation, MutExternalOrigin]]("IMG_LoadAPNGAnimation_IO")
        self._load_avif_animation_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Ptr[IMG_Animation, MutExternalOrigin]]("IMG_LoadAVIFAnimation_IO")
        self._load_gif_animation_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Ptr[IMG_Animation, MutExternalOrigin]]("IMG_LoadGIFAnimation_IO")
        self._load_webp_animation_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin]) -> Ptr[IMG_Animation, MutExternalOrigin]]("IMG_LoadWEBPAnimation_IO")
        self._save_animation = self.dynamic_library_handle.get_function[fn(Ptr[IMG_Animation, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin]) -> Bool]("IMG_SaveAnimation")
        self._save_animation_typed_io = self.dynamic_library_handle.get_function[fn(Ptr[IMG_Animation, MutExternalOrigin], Ptr[IOStream, MutExternalOrigin], Bool, Ptr[c_char, ImmutExternalOrigin]) -> Bool]("IMG_SaveAnimationTyped_IO")
        self._save_ani_animation_io = self.dynamic_library_handle.get_function[fn(Ptr[IMG_Animation, MutExternalOrigin], Ptr[IOStream, MutExternalOrigin], Bool) -> Bool]("IMG_SaveANIAnimation_IO")
        self._save_apng_animation_io = self.dynamic_library_handle.get_function[fn(Ptr[IMG_Animation, MutExternalOrigin], Ptr[IOStream, MutExternalOrigin], Bool) -> Bool]("IMG_SaveAPNGAnimation_IO")
        self._save_avif_animation_io = self.dynamic_library_handle.get_function[fn(Ptr[IMG_Animation, MutExternalOrigin], Ptr[IOStream, MutExternalOrigin], Bool, Int32) -> Bool]("IMG_SaveAVIFAnimation_IO")
        self._save_gif_animation_io = self.dynamic_library_handle.get_function[fn(Ptr[IMG_Animation, MutExternalOrigin], Ptr[IOStream, MutExternalOrigin], Bool) -> Bool]("IMG_SaveGIFAnimation_IO")
        self._save_webp_animation_io = self.dynamic_library_handle.get_function[fn(Ptr[IMG_Animation, MutExternalOrigin], Ptr[IOStream, MutExternalOrigin], Bool, Int32) -> Bool]("IMG_SaveWEBPAnimation_IO")
        self._create_animated_cursor = self.dynamic_library_handle.get_function[fn(Ptr[IMG_Animation, MutExternalOrigin], Int32, Int32) -> Ptr[Cursor, MutExternalOrigin]]("IMG_CreateAnimatedCursor")
        self._free_animation = self.dynamic_library_handle.get_function[fn(Ptr[IMG_Animation, MutExternalOrigin]) -> NoneType]("IMG_FreeAnimation")
        self._create_animation_encoder = self.dynamic_library_handle.get_function[fn(Ptr[c_char, ImmutExternalOrigin]) -> Ptr[IMG_AnimationEncoder, MutExternalOrigin]]("IMG_CreateAnimationEncoder")
        self._create_animation_encoder_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin], Bool, Ptr[c_char, ImmutExternalOrigin]) -> Ptr[IMG_AnimationEncoder, MutExternalOrigin]]("IMG_CreateAnimationEncoder_IO")
        self._create_animation_encoder_with_properties = self.dynamic_library_handle.get_function[fn(PropertiesID) -> Ptr[IMG_AnimationEncoder, MutExternalOrigin]]("IMG_CreateAnimationEncoderWithProperties")
        self._add_animation_encoder_frame = self.dynamic_library_handle.get_function[fn(Ptr[IMG_AnimationEncoder, MutExternalOrigin], Ptr[Surface, MutExternalOrigin], UInt64) -> Bool]("IMG_AddAnimationEncoderFrame")
        self._close_animation_encoder = self.dynamic_library_handle.get_function[fn(Ptr[IMG_AnimationEncoder, MutExternalOrigin]) -> Bool]("IMG_CloseAnimationEncoder")
        self._create_animation_decoder = self.dynamic_library_handle.get_function[fn(Ptr[c_char, ImmutExternalOrigin]) -> Ptr[IMG_AnimationDecoder, MutExternalOrigin]]("IMG_CreateAnimationDecoder")
        self._create_animation_decoder_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin], Bool, Ptr[c_char, ImmutExternalOrigin]) -> Ptr[IMG_AnimationDecoder, MutExternalOrigin]]("IMG_CreateAnimationDecoder_IO")
        self._create_animation_decoder_with_properties = self.dynamic_library_handle.get_function[fn(PropertiesID) -> Ptr[IMG_AnimationDecoder, MutExternalOrigin]]("IMG_CreateAnimationDecoderWithProperties")
        self._get_animation_decoder_properties = self.dynamic_library_handle.get_function[fn(Ptr[IMG_AnimationDecoder, MutExternalOrigin]) -> PropertiesID]("IMG_GetAnimationDecoderProperties")
        self._get_animation_decoder_frame = self.dynamic_library_handle.get_function[fn(Ptr[IMG_AnimationDecoder, MutExternalOrigin], Ptr[Ptr[Surface, MutExternalOrigin], MutExternalOrigin], Ptr[UInt64, MutExternalOrigin]) -> Bool]("IMG_GetAnimationDecoderFrame")
        self._get_animation_decoder_status = self.dynamic_library_handle.get_function[fn(Ptr[IMG_AnimationDecoder, MutExternalOrigin]) -> IMG_AnimationDecoderStatus]("IMG_GetAnimationDecoderStatus")
        self._reset_animation_decoder = self.dynamic_library_handle.get_function[fn(Ptr[IMG_AnimationDecoder, MutExternalOrigin]) -> Bool]("IMG_ResetAnimationDecoder")
        self._close_animation_decoder = self.dynamic_library_handle.get_function[fn(Ptr[IMG_AnimationDecoder, MutExternalOrigin]) -> Bool]("IMG_CloseAnimationDecoder")
