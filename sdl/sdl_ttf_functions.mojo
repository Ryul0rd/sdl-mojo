...
struct SdlTtfFunctions:
    ...
    fn __init__(out self, sdl3_functions: Sdl3Functions, library_path: Path) raises:
        ...
        self._version = self.dynamic_library_handle.get_function[fn() -> Int32]("TTF_Version")
        self._get_free_type_version = self.dynamic_library_handle.get_function[fn(Ptr[Int32, MutExternalOrigin], Ptr[Int32, MutExternalOrigin], Ptr[Int32, MutExternalOrigin]) -> NoneType]("TTF_GetFreeTypeVersion")
        self._get_harf_buzz_version = self.dynamic_library_handle.get_function[fn(Ptr[Int32, MutExternalOrigin], Ptr[Int32, MutExternalOrigin], Ptr[Int32, MutExternalOrigin]) -> NoneType]("TTF_GetHarfBuzzVersion")
        self._init = self.dynamic_library_handle.get_function[fn() -> Bool]("TTF_Init")
        self._open_font = self.dynamic_library_handle.get_function[fn(Ptr[c_char, ImmutExternalOrigin], Float32) -> Ptr[TTF_Font, MutExternalOrigin]]("TTF_OpenFont")
        self._open_font_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin], Bool, Float32) -> Ptr[TTF_Font, MutExternalOrigin]]("TTF_OpenFontIO")
        self._open_font_with_properties = self.dynamic_library_handle.get_function[fn(PropertiesID) -> Ptr[TTF_Font, MutExternalOrigin]]("TTF_OpenFontWithProperties")
        self._copy_font = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin]) -> Ptr[TTF_Font, MutExternalOrigin]]("TTF_CopyFont")
        self._get_font_properties = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin]) -> PropertiesID]("TTF_GetFontProperties")
        self._get_font_generation = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin]) -> UInt32]("TTF_GetFontGeneration")
        self._add_fallback_font = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], Ptr[TTF_Font, MutExternalOrigin]) -> Bool]("TTF_AddFallbackFont")
        self._remove_fallback_font = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], Ptr[TTF_Font, MutExternalOrigin]) -> NoneType]("TTF_RemoveFallbackFont")
        self._clear_fallback_fonts = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin]) -> NoneType]("TTF_ClearFallbackFonts")
        self._set_font_size = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], Float32) -> Bool]("TTF_SetFontSize")
        self._set_font_size_dpi = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], Float32, Int32, Int32) -> Bool]("TTF_SetFontSizeDPI")
        self._get_font_size = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin]) -> Float32]("TTF_GetFontSize")
        self._get_font_dpi = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], Ptr[Int32, MutExternalOrigin], Ptr[Int32, MutExternalOrigin]) -> Bool]("TTF_GetFontDPI")
        self._set_font_style = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], TTF_FontStyleFlags) -> NoneType]("TTF_SetFontStyle")
        self._get_font_style = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, ImmutExternalOrigin]) -> TTF_FontStyleFlags]("TTF_GetFontStyle")
        self._set_font_outline = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], Int32) -> Bool]("TTF_SetFontOutline")
        self._get_font_outline = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, ImmutExternalOrigin]) -> Int32]("TTF_GetFontOutline")
        self._set_font_hinting = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], TTF_HintingFlags) -> NoneType]("TTF_SetFontHinting")
        self._get_num_font_faces = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, ImmutExternalOrigin]) -> Int32]("TTF_GetNumFontFaces")
        self._get_font_hinting = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, ImmutExternalOrigin]) -> TTF_HintingFlags]("TTF_GetFontHinting")
        self._set_font_sdf = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], Bool) -> Bool]("TTF_SetFontSDF")
        self._get_font_sdf = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, ImmutExternalOrigin]) -> Bool]("TTF_GetFontSDF")
        self._get_font_weight = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, ImmutExternalOrigin]) -> Int32]("TTF_GetFontWeight")
        self._set_font_wrap_alignment = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], TTF_HorizontalAlignment) -> NoneType]("TTF_SetFontWrapAlignment")
        self._get_font_wrap_alignment = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, ImmutExternalOrigin]) -> TTF_HorizontalAlignment]("TTF_GetFontWrapAlignment")
        self._get_font_height = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, ImmutExternalOrigin]) -> Int32]("TTF_GetFontHeight")
        self._get_font_ascent = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, ImmutExternalOrigin]) -> Int32]("TTF_GetFontAscent")
        self._get_font_descent = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, ImmutExternalOrigin]) -> Int32]("TTF_GetFontDescent")
        self._set_font_line_skip = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], Int32) -> NoneType]("TTF_SetFontLineSkip")
        self._get_font_line_skip = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, ImmutExternalOrigin]) -> Int32]("TTF_GetFontLineSkip")
        self._set_font_kerning = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], Bool) -> NoneType]("TTF_SetFontKerning")
        self._get_font_kerning = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, ImmutExternalOrigin]) -> Bool]("TTF_GetFontKerning")
        self._font_is_fixed_width = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, ImmutExternalOrigin]) -> Bool]("TTF_FontIsFixedWidth")
        self._font_is_scalable = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, ImmutExternalOrigin]) -> Bool]("TTF_FontIsScalable")
        self._get_font_family_name = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, ImmutExternalOrigin]) -> CStringSlice[ImmutExternalOrigin]]("TTF_GetFontFamilyName")
        self._get_font_style_name = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, ImmutExternalOrigin]) -> CStringSlice[ImmutExternalOrigin]]("TTF_GetFontStyleName")
        self._set_font_direction = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], TTF_Direction) -> Bool]("TTF_SetFontDirection")
        self._get_font_direction = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin]) -> TTF_Direction]("TTF_GetFontDirection")
        self._string_to_tag = self.dynamic_library_handle.get_function[fn(Ptr[c_char, ImmutExternalOrigin]) -> UInt32]("TTF_StringToTag")
        self._tag_to_string = self.dynamic_library_handle.get_function[fn(UInt32, Ptr[c_char, MutExternalOrigin], Int32) -> NoneType]("TTF_TagToString")
        self._set_font_script = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], UInt32) -> Bool]("TTF_SetFontScript")
        self._get_font_script = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin]) -> UInt32]("TTF_GetFontScript")
        self._get_glyph_script = self.dynamic_library_handle.get_function[fn(UInt32) -> UInt32]("TTF_GetGlyphScript")
        self._set_font_language = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin]) -> Bool]("TTF_SetFontLanguage")
        self._font_has_glyph = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], UInt32) -> Bool]("TTF_FontHasGlyph")
        self._get_glyph_image = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], UInt32, Ptr[TTF_ImageType, MutExternalOrigin]) -> Ptr[Surface, MutExternalOrigin]]("TTF_GetGlyphImage")
        self._get_glyph_image_for_index = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], UInt32, Ptr[TTF_ImageType, MutExternalOrigin]) -> Ptr[Surface, MutExternalOrigin]]("TTF_GetGlyphImageForIndex")
        self._get_glyph_metrics = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], UInt32, Ptr[Int32, MutExternalOrigin], Ptr[Int32, MutExternalOrigin], Ptr[Int32, MutExternalOrigin], Ptr[Int32, MutExternalOrigin], Ptr[Int32, MutExternalOrigin]) -> Bool]("TTF_GetGlyphMetrics")
        self._get_glyph_kerning = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], UInt32, UInt32, Ptr[Int32, MutExternalOrigin]) -> Bool]("TTF_GetGlyphKerning")
        self._get_string_size = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin], Int32, Ptr[Int32, MutExternalOrigin], Ptr[Int32, MutExternalOrigin]) -> Bool]("TTF_GetStringSize")
        self._get_string_size_wrapped = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin], Int32, Int32, Ptr[Int32, MutExternalOrigin], Ptr[Int32, MutExternalOrigin]) -> Bool]("TTF_GetStringSizeWrapped")
        self._measure_string = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin], Int32, Int32, Ptr[Int32, MutExternalOrigin], Ptr[Int32, MutExternalOrigin]) -> Bool]("TTF_MeasureString")
        self._render_text_solid = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin], Int32, Color) -> Ptr[Surface, MutExternalOrigin]]("TTF_RenderText_Solid")
        self._render_text_solid_wrapped = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin], Int32, Color, Int32) -> Ptr[Surface, MutExternalOrigin]]("TTF_RenderText_Solid_Wrapped")
        self._render_glyph_solid = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], UInt32, Color) -> Ptr[Surface, MutExternalOrigin]]("TTF_RenderGlyph_Solid")
        self._render_text_shaded = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin], Int32, Color, Color) -> Ptr[Surface, MutExternalOrigin]]("TTF_RenderText_Shaded")
        self._render_text_shaded_wrapped = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin], Int32, Color, Color, Int32) -> Ptr[Surface, MutExternalOrigin]]("TTF_RenderText_Shaded_Wrapped")
        self._render_glyph_shaded = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], UInt32, Color, Color) -> Ptr[Surface, MutExternalOrigin]]("TTF_RenderGlyph_Shaded")
        self._render_text_blended = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin], Int32, Color) -> Ptr[Surface, MutExternalOrigin]]("TTF_RenderText_Blended")
        self._render_text_blended_wrapped = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin], Int32, Color, Int32) -> Ptr[Surface, MutExternalOrigin]]("TTF_RenderText_Blended_Wrapped")
        self._render_glyph_blended = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], UInt32, Color) -> Ptr[Surface, MutExternalOrigin]]("TTF_RenderGlyph_Blended")
        self._render_text_lcd = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin], Int32, Color, Color) -> Ptr[Surface, MutExternalOrigin]]("TTF_RenderText_LCD")
        self._render_text_lcd_wrapped = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin], Int32, Color, Color, Int32) -> Ptr[Surface, MutExternalOrigin]]("TTF_RenderText_LCD_Wrapped")
        self._render_glyph_lcd = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin], UInt32, Color, Color) -> Ptr[Surface, MutExternalOrigin]]("TTF_RenderGlyph_LCD")
        self._create_surface_text_engine = self.dynamic_library_handle.get_function[fn() -> Ptr[TTF_TextEngine, MutExternalOrigin]]("TTF_CreateSurfaceTextEngine")
        self._draw_surface_text = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin], Int32, Int32, Ptr[Surface, MutExternalOrigin]) -> Bool]("TTF_DrawSurfaceText")
        self._destroy_surface_text_engine = self.dynamic_library_handle.get_function[fn(Ptr[TTF_TextEngine, MutExternalOrigin]) -> NoneType]("TTF_DestroySurfaceTextEngine")
        self._create_renderer_text_engine = self.dynamic_library_handle.get_function[fn(Ptr[Renderer, MutExternalOrigin]) -> Ptr[TTF_TextEngine, MutExternalOrigin]]("TTF_CreateRendererTextEngine")
        self._create_renderer_text_engine_with_properties = self.dynamic_library_handle.get_function[fn(PropertiesID) -> Ptr[TTF_TextEngine, MutExternalOrigin]]("TTF_CreateRendererTextEngineWithProperties")
        self._draw_renderer_text = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin], Float32, Float32) -> Bool]("TTF_DrawRendererText")
        self._destroy_renderer_text_engine = self.dynamic_library_handle.get_function[fn(Ptr[TTF_TextEngine, MutExternalOrigin]) -> NoneType]("TTF_DestroyRendererTextEngine")
        self._create_gpu_text_engine = self.dynamic_library_handle.get_function[fn(Ptr[GPUDevice, MutExternalOrigin]) -> Ptr[TTF_TextEngine, MutExternalOrigin]]("TTF_CreateGPUTextEngine")
        self._create_gpu_text_engine_with_properties = self.dynamic_library_handle.get_function[fn(PropertiesID) -> Ptr[TTF_TextEngine, MutExternalOrigin]]("TTF_CreateGPUTextEngineWithProperties")
        self._get_gpu_text_draw_data = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin]) -> Ptr[TTF_GPUAtlasDrawSequence, MutExternalOrigin]]("TTF_GetGPUTextDrawData")
        self._destroy_gpu_text_engine = self.dynamic_library_handle.get_function[fn(Ptr[TTF_TextEngine, MutExternalOrigin]) -> NoneType]("TTF_DestroyGPUTextEngine")
        self._set_gpu_text_engine_winding = self.dynamic_library_handle.get_function[fn(Ptr[TTF_TextEngine, MutExternalOrigin], TTF_GPUTextEngineWinding) -> NoneType]("TTF_SetGPUTextEngineWinding")
        self._get_gpu_text_engine_winding = self.dynamic_library_handle.get_function[fn(Ptr[TTF_TextEngine, ImmutExternalOrigin]) -> TTF_GPUTextEngineWinding]("TTF_GetGPUTextEngineWinding")
        self._create_text = self.dynamic_library_handle.get_function[fn(Ptr[TTF_TextEngine, MutExternalOrigin], Ptr[TTF_Font, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin], Int32) -> Ptr[TTF_Text, MutExternalOrigin]]("TTF_CreateText")
        self._get_text_properties = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin]) -> PropertiesID]("TTF_GetTextProperties")
        self._set_text_engine = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin], Ptr[TTF_TextEngine, MutExternalOrigin]) -> Bool]("TTF_SetTextEngine")
        self._get_text_engine = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin]) -> Ptr[TTF_TextEngine, MutExternalOrigin]]("TTF_GetTextEngine")
        self._set_text_font = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin], Ptr[TTF_Font, MutExternalOrigin]) -> Bool]("TTF_SetTextFont")
        self._get_text_font = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin]) -> Ptr[TTF_Font, MutExternalOrigin]]("TTF_GetTextFont")
        self._set_text_direction = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin], TTF_Direction) -> Bool]("TTF_SetTextDirection")
        self._get_text_direction = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin]) -> TTF_Direction]("TTF_GetTextDirection")
        self._set_text_script = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin], UInt32) -> Bool]("TTF_SetTextScript")
        self._get_text_script = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin]) -> UInt32]("TTF_GetTextScript")
        self._set_text_color = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin], UInt8, UInt8, UInt8, UInt8) -> Bool]("TTF_SetTextColor")
        self._set_text_color_float = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin], Float32, Float32, Float32, Float32) -> Bool]("TTF_SetTextColorFloat")
        self._get_text_color = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin], Ptr[UInt8, MutExternalOrigin], Ptr[UInt8, MutExternalOrigin], Ptr[UInt8, MutExternalOrigin], Ptr[UInt8, MutExternalOrigin]) -> Bool]("TTF_GetTextColor")
        self._get_text_color_float = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin], Ptr[Float32, MutExternalOrigin], Ptr[Float32, MutExternalOrigin], Ptr[Float32, MutExternalOrigin], Ptr[Float32, MutExternalOrigin]) -> Bool]("TTF_GetTextColorFloat")
        self._set_text_position = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin], Int32, Int32) -> Bool]("TTF_SetTextPosition")
        self._get_text_position = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin], Ptr[Int32, MutExternalOrigin], Ptr[Int32, MutExternalOrigin]) -> Bool]("TTF_GetTextPosition")
        self._set_text_wrap_width = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin], Int32) -> Bool]("TTF_SetTextWrapWidth")
        self._get_text_wrap_width = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin], Ptr[Int32, MutExternalOrigin]) -> Bool]("TTF_GetTextWrapWidth")
        self._set_text_wrap_whitespace_visible = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin], Bool) -> Bool]("TTF_SetTextWrapWhitespaceVisible")
        self._text_wrap_whitespace_visible = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin]) -> Bool]("TTF_TextWrapWhitespaceVisible")
        self._set_text_string = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin], Int32) -> Bool]("TTF_SetTextString")
        self._insert_text_string = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin], Int32, Ptr[c_char, ImmutExternalOrigin], Int32) -> Bool]("TTF_InsertTextString")
        self._append_text_string = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin], Int32) -> Bool]("TTF_AppendTextString")
        self._delete_text_string = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin], Int32, Int32) -> Bool]("TTF_DeleteTextString")
        self._get_text_size = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin], Ptr[Int32, MutExternalOrigin], Ptr[Int32, MutExternalOrigin]) -> Bool]("TTF_GetTextSize")
        self._get_text_sub_string = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin], Int32, Ptr[TTF_SubString, MutExternalOrigin]) -> Bool]("TTF_GetTextSubString")
        self._get_text_sub_string_for_line = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin], Int32, Ptr[TTF_SubString, MutExternalOrigin]) -> Bool]("TTF_GetTextSubStringForLine")
        self._get_text_sub_strings_for_range = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin], Int32, Int32, Ptr[Int32, MutExternalOrigin]) -> Ptr[Ptr[TTF_SubString, MutExternalOrigin], MutExternalOrigin]]("TTF_GetTextSubStringsForRange")
        self._get_text_sub_string_for_point = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin], Int32, Int32, Ptr[TTF_SubString, MutExternalOrigin]) -> Bool]("TTF_GetTextSubStringForPoint")
        self._get_previous_text_sub_string = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin], Ptr[TTF_SubString, ImmutExternalOrigin], Ptr[TTF_SubString, MutExternalOrigin]) -> Bool]("TTF_GetPreviousTextSubString")
        self._get_next_text_sub_string = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin], Ptr[TTF_SubString, ImmutExternalOrigin], Ptr[TTF_SubString, MutExternalOrigin]) -> Bool]("TTF_GetNextTextSubString")
        self._update_text = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin]) -> Bool]("TTF_UpdateText")
        self._destroy_text = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Text, MutExternalOrigin]) -> NoneType]("TTF_DestroyText")
        self._close_font = self.dynamic_library_handle.get_function[fn(Ptr[TTF_Font, MutExternalOrigin]) -> NoneType]("TTF_CloseFont")
        self._quit = self.dynamic_library_handle.get_function[fn() -> NoneType]("TTF_Quit")
        self._was_init = self.dynamic_library_handle.get_function[fn() -> Int32]("TTF_WasInit")
