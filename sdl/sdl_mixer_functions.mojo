...
struct SdlMixerFunctions:
    ...
    fn __init__(out self, sdl3_functions: Sdl3Functions, library_path: Path) raises:
        ...
        self._version = self.dynamic_library_handle.get_function[fn() -> Int32]("MIX_Version")
        self._init = self.dynamic_library_handle.get_function[fn() -> Bool]("MIX_Init")
        self._quit = self.dynamic_library_handle.get_function[fn() -> NoneType]("MIX_Quit")
        self._get_num_audio_decoders = self.dynamic_library_handle.get_function[fn() -> Int32]("MIX_GetNumAudioDecoders")
        self._get_audio_decoder = self.dynamic_library_handle.get_function[fn(Int32) -> CStringSlice[ImmutExternalOrigin]]("MIX_GetAudioDecoder")
        self._create_mixer_device = self.dynamic_library_handle.get_function[fn(AudioDeviceID, Ptr[AudioSpec, ImmutExternalOrigin]) -> Ptr[MIX_Mixer, MutExternalOrigin]]("MIX_CreateMixerDevice")
        self._create_mixer = self.dynamic_library_handle.get_function[fn(Ptr[AudioSpec, ImmutExternalOrigin]) -> Ptr[MIX_Mixer, MutExternalOrigin]]("MIX_CreateMixer")
        self._destroy_mixer = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin]) -> NoneType]("MIX_DestroyMixer")
        self._get_mixer_properties = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin]) -> PropertiesID]("MIX_GetMixerProperties")
        self._get_mixer_format = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin], Ptr[AudioSpec, MutExternalOrigin]) -> Bool]("MIX_GetMixerFormat")
        self._load_audio_io = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin], Ptr[IOStream, MutExternalOrigin], Bool, Bool) -> Ptr[MIX_Audio, MutExternalOrigin]]("MIX_LoadAudio_IO")
        self._load_audio = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin], Bool) -> Ptr[MIX_Audio, MutExternalOrigin]]("MIX_LoadAudio")
        self._load_audio_with_properties = self.dynamic_library_handle.get_function[fn(PropertiesID) -> Ptr[MIX_Audio, MutExternalOrigin]]("MIX_LoadAudioWithProperties")
        self._load_raw_audio_io = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin], Ptr[IOStream, MutExternalOrigin], Ptr[AudioSpec, ImmutExternalOrigin], Bool) -> Ptr[MIX_Audio, MutExternalOrigin]]("MIX_LoadRawAudio_IO")
        self._load_raw_audio = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin], Ptr[NoneType, ImmutExternalOrigin], Int32, Ptr[AudioSpec, ImmutExternalOrigin]) -> Ptr[MIX_Audio, MutExternalOrigin]]("MIX_LoadRawAudio")
        self._load_raw_audio_no_copy = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin], Ptr[NoneType, ImmutExternalOrigin], Int32, Ptr[AudioSpec, ImmutExternalOrigin], Bool) -> Ptr[MIX_Audio, MutExternalOrigin]]("MIX_LoadRawAudioNoCopy")
        self._create_sine_wave_audio = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin], Int32, Float32, Int64) -> Ptr[MIX_Audio, MutExternalOrigin]]("MIX_CreateSineWaveAudio")
        self._get_audio_properties = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Audio, MutExternalOrigin]) -> PropertiesID]("MIX_GetAudioProperties")
        self._get_audio_duration = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Audio, MutExternalOrigin]) -> Int64]("MIX_GetAudioDuration")
        self._get_audio_format = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Audio, MutExternalOrigin], Ptr[AudioSpec, MutExternalOrigin]) -> Bool]("MIX_GetAudioFormat")
        self._destroy_audio = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Audio, MutExternalOrigin]) -> NoneType]("MIX_DestroyAudio")
        self._create_track = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin]) -> Ptr[MIX_Track, MutExternalOrigin]]("MIX_CreateTrack")
        self._destroy_track = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin]) -> NoneType]("MIX_DestroyTrack")
        self._get_track_properties = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin]) -> PropertiesID]("MIX_GetTrackProperties")
        self._get_track_mixer = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin]) -> Ptr[MIX_Mixer, MutExternalOrigin]]("MIX_GetTrackMixer")
        self._set_track_audio = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin], Ptr[MIX_Audio, MutExternalOrigin]) -> Bool]("MIX_SetTrackAudio")
        self._set_track_audio_stream = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin], Ptr[AudioStream, MutExternalOrigin]) -> Bool]("MIX_SetTrackAudioStream")
        self._set_track_io_stream = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin], Ptr[IOStream, MutExternalOrigin], Bool) -> Bool]("MIX_SetTrackIOStream")
        self._set_track_raw_io_stream = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin], Ptr[IOStream, MutExternalOrigin], Ptr[AudioSpec, ImmutExternalOrigin], Bool) -> Bool]("MIX_SetTrackRawIOStream")
        self._tag_track = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin]) -> Bool]("MIX_TagTrack")
        self._untag_track = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin]) -> NoneType]("MIX_UntagTrack")
        self._get_track_tags = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin], Ptr[Int32, MutExternalOrigin]) -> Ptr[Ptr[c_char, MutExternalOrigin], MutExternalOrigin]]("MIX_GetTrackTags")
        self._get_tagged_tracks = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin], Ptr[Int32, MutExternalOrigin]) -> Ptr[Ptr[MIX_Track, MutExternalOrigin], MutExternalOrigin]]("MIX_GetTaggedTracks")
        self._set_track_playback_position = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin], Int64) -> Bool]("MIX_SetTrackPlaybackPosition")
        self._get_track_playback_position = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin]) -> Int64]("MIX_GetTrackPlaybackPosition")
        self._get_track_fade_frames = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin]) -> Int64]("MIX_GetTrackFadeFrames")
        self._get_track_loops = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin]) -> Int32]("MIX_GetTrackLoops")
        self._set_track_loops = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin], Int32) -> Bool]("MIX_SetTrackLoops")
        self._get_track_audio = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin]) -> Ptr[MIX_Audio, MutExternalOrigin]]("MIX_GetTrackAudio")
        self._get_track_audio_stream = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin]) -> Ptr[AudioStream, MutExternalOrigin]]("MIX_GetTrackAudioStream")
        self._get_track_remaining = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin]) -> Int64]("MIX_GetTrackRemaining")
        self._track_ms_to_frames = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin], Int64) -> Int64]("MIX_TrackMSToFrames")
        self._track_frames_to_ms = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin], Int64) -> Int64]("MIX_TrackFramesToMS")
        self._audio_ms_to_frames = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Audio, MutExternalOrigin], Int64) -> Int64]("MIX_AudioMSToFrames")
        self._audio_frames_to_ms = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Audio, MutExternalOrigin], Int64) -> Int64]("MIX_AudioFramesToMS")
        self._ms_to_frames = self.dynamic_library_handle.get_function[fn(Int32, Int64) -> Int64]("MIX_MSToFrames")
        self._frames_to_ms = self.dynamic_library_handle.get_function[fn(Int32, Int64) -> Int64]("MIX_FramesToMS")
        self._play_track = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin], PropertiesID) -> Bool]("MIX_PlayTrack")
        self._play_tag = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin], PropertiesID) -> Bool]("MIX_PlayTag")
        self._play_audio = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin], Ptr[MIX_Audio, MutExternalOrigin]) -> Bool]("MIX_PlayAudio")
        self._stop_track = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin], Int64) -> Bool]("MIX_StopTrack")
        self._stop_all_tracks = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin], Int64) -> Bool]("MIX_StopAllTracks")
        self._stop_tag = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin], Int64) -> Bool]("MIX_StopTag")
        self._pause_track = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin]) -> Bool]("MIX_PauseTrack")
        self._pause_all_tracks = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin]) -> Bool]("MIX_PauseAllTracks")
        self._pause_tag = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin]) -> Bool]("MIX_PauseTag")
        self._resume_track = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin]) -> Bool]("MIX_ResumeTrack")
        self._resume_all_tracks = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin]) -> Bool]("MIX_ResumeAllTracks")
        self._resume_tag = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin]) -> Bool]("MIX_ResumeTag")
        self._track_playing = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin]) -> Bool]("MIX_TrackPlaying")
        self._track_paused = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin]) -> Bool]("MIX_TrackPaused")
        self._set_mixer_gain = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin], Float32) -> Bool]("MIX_SetMixerGain")
        self._get_mixer_gain = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin]) -> Float32]("MIX_GetMixerGain")
        self._set_track_gain = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin], Float32) -> Bool]("MIX_SetTrackGain")
        self._get_track_gain = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin]) -> Float32]("MIX_GetTrackGain")
        self._set_tag_gain = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin], Ptr[c_char, ImmutExternalOrigin], Float32) -> Bool]("MIX_SetTagGain")
        self._set_mixer_frequency_ratio = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin], Float32) -> Bool]("MIX_SetMixerFrequencyRatio")
        self._get_mixer_frequency_ratio = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin]) -> Float32]("MIX_GetMixerFrequencyRatio")
        self._set_track_frequency_ratio = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin], Float32) -> Bool]("MIX_SetTrackFrequencyRatio")
        self._get_track_frequency_ratio = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin]) -> Float32]("MIX_GetTrackFrequencyRatio")
        self._set_track_output_channel_map = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin], Ptr[Int32, ImmutExternalOrigin], Int32) -> Bool]("MIX_SetTrackOutputChannelMap")
        self._set_track_stereo = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin], Ptr[MIX_StereoGains, ImmutExternalOrigin]) -> Bool]("MIX_SetTrackStereo")
        self._set_track3_d_position = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin], Ptr[MIX_Point3D, ImmutExternalOrigin]) -> Bool]("MIX_SetTrack3DPosition")
        self._get_track3_d_position = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin], Ptr[MIX_Point3D, MutExternalOrigin]) -> Bool]("MIX_GetTrack3DPosition")
        self._create_group = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin]) -> Ptr[MIX_Group, MutExternalOrigin]]("MIX_CreateGroup")
        self._destroy_group = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Group, MutExternalOrigin]) -> NoneType]("MIX_DestroyGroup")
        self._get_group_properties = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Group, MutExternalOrigin]) -> PropertiesID]("MIX_GetGroupProperties")
        self._get_group_mixer = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Group, MutExternalOrigin]) -> Ptr[MIX_Mixer, MutExternalOrigin]]("MIX_GetGroupMixer")
        self._set_track_group = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin], Ptr[MIX_Group, MutExternalOrigin]) -> Bool]("MIX_SetTrackGroup")
        self._set_track_stopped_callback = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin], MIX_TrackStoppedCallback, Ptr[NoneType, MutExternalOrigin]) -> Bool]("MIX_SetTrackStoppedCallback")
        self._set_track_raw_callback = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin], MIX_TrackMixCallback, Ptr[NoneType, MutExternalOrigin]) -> Bool]("MIX_SetTrackRawCallback")
        self._set_track_cooked_callback = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Track, MutExternalOrigin], MIX_TrackMixCallback, Ptr[NoneType, MutExternalOrigin]) -> Bool]("MIX_SetTrackCookedCallback")
        self._set_group_post_mix_callback = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Group, MutExternalOrigin], MIX_GroupMixCallback, Ptr[NoneType, MutExternalOrigin]) -> Bool]("MIX_SetGroupPostMixCallback")
        self._set_post_mix_callback = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin], MIX_PostMixCallback, Ptr[NoneType, MutExternalOrigin]) -> Bool]("MIX_SetPostMixCallback")
        self._generate = self.dynamic_library_handle.get_function[fn(Ptr[MIX_Mixer, MutExternalOrigin], Ptr[NoneType, MutExternalOrigin], Int32) -> Bool]("MIX_Generate")
        self._create_audio_decoder = self.dynamic_library_handle.get_function[fn(Ptr[c_char, ImmutExternalOrigin], PropertiesID) -> Ptr[MIX_AudioDecoder, MutExternalOrigin]]("MIX_CreateAudioDecoder")
        self._create_audio_decoder_io = self.dynamic_library_handle.get_function[fn(Ptr[IOStream, MutExternalOrigin], Bool, PropertiesID) -> Ptr[MIX_AudioDecoder, MutExternalOrigin]]("MIX_CreateAudioDecoder_IO")
        self._destroy_audio_decoder = self.dynamic_library_handle.get_function[fn(Ptr[MIX_AudioDecoder, MutExternalOrigin]) -> NoneType]("MIX_DestroyAudioDecoder")
        self._get_audio_decoder_properties = self.dynamic_library_handle.get_function[fn(Ptr[MIX_AudioDecoder, MutExternalOrigin]) -> PropertiesID]("MIX_GetAudioDecoderProperties")
        self._get_audio_decoder_format = self.dynamic_library_handle.get_function[fn(Ptr[MIX_AudioDecoder, MutExternalOrigin], Ptr[AudioSpec, MutExternalOrigin]) -> Bool]("MIX_GetAudioDecoderFormat")
        self._decode_audio = self.dynamic_library_handle.get_function[fn(Ptr[MIX_AudioDecoder, MutExternalOrigin], Ptr[NoneType, MutExternalOrigin], Int32, Ptr[AudioSpec, ImmutExternalOrigin]) -> Int32]("MIX_DecodeAudio")
